...
class PredictionRequest(BaseModel):
    ...
    features: HousingFeatures = Field(..., description="Housing features for prediction")
...
class PredictionResponse(BaseModel):
    ...
    prediction: float = Field(..., description="Predicted house price (in hundreds of thousands of dollars)")
